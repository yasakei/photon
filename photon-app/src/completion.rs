...
use photon_rpc::{plugin::PluginId, proxy::ProxyRpcHandler};
use lsp_types::{
...
use crate::{config::PhotonConfig, editor::EditorData, snippet::Snippet};
...
impl CompletionData {
    pub fn new(cx: Scope, config: ReadSignal<Arc<PhotonConfig>>) -> Self {
...
fn completion_lens_text(
    ...
    // Get only the first line of text, because Photon does not currently support
