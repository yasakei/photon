...
use photon_proxy::dispatch::Dispatcher;
use photon_rpc::{
...
impl CoreHandler for Proxy {
    fn handle_notification(&mut self, rpc: photon_rpc::core::CoreNotification) {
    ...
    fn handle_request(
        &mut self,
        _id: photon_rpc::RequestId,
        _rpc: photon_rpc::core::CoreRequest,
    ) {
    }
}
