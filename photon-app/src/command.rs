...
pub enum CommandKind {
    Workbench(PhotonWorkbenchCommand),
    Edit(EditCommand),
    Move(MoveCommand),
...
pub fn photon_internal_commands() -> IndexMap<String, PhotonCommand> {
    let mut commands = IndexMap::new();

    for c in PhotonWorkbenchCommand::iter() {
        let command = PhotonCommand {
...
pub enum PhotonWorkbenchCommand {
    ...
    #[cfg(target_os = "macos")]
    #[strum(message = "Install Photon to PATH")]
    #[strum(serialize = "install_to_path")]
    InstallToPATH,

    #[cfg(target_os = "macos")]
    #[strum(message = "Uninstall Photon from PATH")]
    ...
    #[strum(serialize = "quick_jump_1")]
    #[strum(message = "Quick Jump 1 (Alt Quick Jump)")]
    QuickJump1,

    #[strum(serialize = "quick_jump_2")]
    #[strum(message = "Quick Jump 2 (Alt Quick Jump)")]
    QuickJump2,

    #[strum(serialize = "quick_jump_3")]
    #[strum(message = "Quick Jump 3 (Alt Quick Jump)")]
    QuickJump3,

    #[strum(serialize = "quick_jump_4")]
    #[strum(message = "Quick Jump 4 (Alt Quick Jump)")]
    QuickJump4,

    #[strum(serialize = "quick_jump_5")]
    #[strum(message = "Quick Jump 5 (Alt Quick Jump)")]
    QuickJump5,

    #[strum(serialize = "quick_jump_6")]
    #[strum(message = "Quick Jump 6 (Alt Quick Jump)")]
    QuickJump6,

    #[strum(serialize = "quick_jump_7")]
    #[strum(message = "Quick Jump 7 (Alt Quick Jump)")]
    QuickJump7,

    #[strum(serialize = "quick_jump_8")]
    #[strum(message = "Quick Jump 8 (Alt Quick Jump)")]
    QuickJump8,

    #[strum(serialize = "quick_jump_9")]
    #[strum(message = "Quick Jump 9 (Alt Quick Jump)")]
    QuickJump9,
}

impl PhotonWorkbenchCommand {
    /// Digit for Alt quick-jump commands (`quick_jump_0`..`quick_jump_9`).
    pub fn quick_jump_digit(&self) -> Option<usize> {
        match self {
            PhotonWorkbenchCommand::QuickJump0 => Some(0),
            PhotonWorkbenchCommand::QuickJump1 => Some(1),
            PhotonWorkbenchCommand::QuickJump2 => Some(2),
            PhotonWorkbenchCommand::QuickJump3 => Some(3),
            PhotonWorkbenchCommand::QuickJump4 => Some(4),
            PhotonWorkbenchCommand::QuickJump5 => Some(5),
            PhotonWorkbenchCommand::QuickJump6 => Some(6),
            PhotonWorkbenchCommand::QuickJump7 => Some(7),
            PhotonWorkbenchCommand::QuickJump8 => Some(8),
            PhotonWorkbenchCommand::QuickJump9 => Some(9),
            _ => None,
        }
    }
}
