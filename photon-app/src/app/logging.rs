...
pub(super) fn logging() -> (Handle<Targets>, Option<WorkerGuard>) {
    ...
    let log_file_filter_targets = filter::Targets::new()
        .with_target("photon_app", LevelFilter::DEBUG)
        .with_target("photon_proxy", LevelFilter::DEBUG)
        .with_target("photon_core", LevelFilter::DEBUG)
    ...
    let console_filter_targets = std::env::var("PHOTON_LOG")
        .unwrap_or_default()
