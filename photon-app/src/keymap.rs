...
pub struct KeymapPicker {
    cmd: RwSignal<Option<PhotonCommand>>,
...
pub fn keymap_view(editors: Editors, common: Rc<CommonData>) -> impl View {
    ...
    let items = move || {
        ...
        let mut items = keypress
            ...
            .collect::<im::Vector<(PhotonCommand, Option<KeyMap>)>>();
        ...
        items
            .into_iter()
            .enumerate()
            .collect::<im::Vector<(usize, (PhotonCommand, Option<KeyMap>))>>()
    };

    let view_fn =
        move |(i, (cmd, keymap)): (usize, (PhotonCommand, Option<KeyMap>))| {
            ...
            .style(move |s| {
                ...
                s.items_center()
                    ...
                    .width_pct(100.0)
                    .apply_if(i % 2 > 0, |s| {
                        s.background(config.color(PhotonColor::EDITOR_CURRENT_LINE))
                    })
                    .border_bottom(1.0)
    ...
    stack((
        ...
        .style(move |s| {
            ...
            s.font_bold()
                ...
                .border_bottom(1.0)
                .border_color(config.color(PhotonColor::PHOTON_BORDER))
                .background(config.color(PhotonColor::EDITOR_CURRENT_LINE))
        }),
        container(
            scroll(
                virtual_stack(
