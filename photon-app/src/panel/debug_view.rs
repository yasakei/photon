                ...
                stack((
                    {
                        let svg_str = match (&p.mode, p.stopped) {
                            (RunDebugMode::Run, false) => PhotonIcons::START,
                            (RunDebugMode::Run, true) => PhotonIcons::RUN_ERRORS,
                            (RunDebugMode::Debug, false) => PhotonIcons::DEBUG,
                            (RunDebugMode::Debug, true) => {
                                PhotonIcons::DEBUG_DISCONNECT
                            }
                        };
                        ...
                        s.items_center()
                            ...
                            .hover(|s| {
                                s.apply_if(reference > 0, |s| {
                                    s.background(
                                        config.get().color(
                                            PhotonColor::PANEL_HOVERED_BACKGROUND,
                                        ),
                                    )
                                })
                            })
                ...
                .style(move |s| {
                    ...
                    s.padding_left(20.0)
                        ...
                        .apply_if(!has_source, |s| {
                            s.color(config.color(PhotonColor::EDITOR_DIM))
                        })
                        .hover(|s| {
                            s.background(
                                config.color(PhotonColor::PANEL_HOVERED_BACKGROUND),
