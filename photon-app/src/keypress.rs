...
use photon_core::mode::{Mode, Modes};
...
use crate::{
    command::{CommandExecuted, CommandKind, PhotonCommand, photon_internal_commands},
    config::PhotonConfig,
    keypress::{
...
pub struct KeyPressData {
    ...
    pub commands: Rc<IndexMap<String, PhotonCommand>>,
    ...
    pub commands_without_keymap: Rc<Vec<PhotonCommand>>,
}

impl KeyPressData {
    pub fn new(cx: Scope, config: &PhotonConfig) -> Self {
        ...
        let mut keypress = Self {
            ...
            commands: Rc::new(photon_internal_commands()),
    ...
    pub fn update_keymaps(&mut self, config: &PhotonConfig) {
