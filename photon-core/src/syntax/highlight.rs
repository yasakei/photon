...
use crate::{language::PhotonLanguage, style::SCOPES};

thread_local! {
    static HIGHLIGHT_CONFIGS: RefCell<HashMap<PhotonLanguage, Result<Arc<HighlightConfiguration>, HighlightIssue>>> = Default::default();
}
